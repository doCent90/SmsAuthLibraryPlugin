...
public class UniGifImage : MonoBehaviour
{
    ...
    /// </summary>
    /// <param name="path">GIF image url (WEB or StreamingAssets path)</param>
    /// <param name="autoPlay">Auto play after decode</param>
    /// <returns>IEnumerator</returns>
    public IEnumerator SetGifFromUrlCoroutine(string path, bool autoPlay = true)
    {
        ...
        string localPath;
        localPath = Path.Combine("file:///" + Application.streamingAssetsPath, path);
